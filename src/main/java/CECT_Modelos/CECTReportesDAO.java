...
public class CECTReportesDAO {
    ...
    // 2.3 Reporte de conteo por marca (incluyendo marcas con 0 motos) - 5 pts
    ...
    // 2.4 Clasificación de marcas (ALTA DEMANDA / MEDIA / SIN STOCK + cilindraje promedio) - 4 pts
    public String obtenerClasificacionMarcas() {
        StringBuilder reporte = new StringBuilder();
        /* * Usamos CASE en SQL para clasificar automáticamente.
         * NOTA: Ajusté la regla así: 0 = SIN STOCK, 1 a 2 = MEDIA, 3 o más = ALTA DEMANDA.
         * Usamos IFNULL(AVG(...), 0) para que el promedio no devuelva "null" si no hay motos.
         */
    ...
    // 2.5 Reporte de colores (Color, Cantidad, lista de marcas)
    public String obtenerColoresMarca() {
        StringBuilder reporte = new StringBuilder();
        /*
         * GROUP_CONCAT es una función genial de MySQL que toma múltiples filas 
         * y las une en una sola línea separada por comas. Usamos DISTINCT para que
         * si hay 3 motos rojas de la misma marca, solo ponga el nombre de la marca una vez.
         */
